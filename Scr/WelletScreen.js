...
const WelletScreen = ({ searchQuery, searchType }) => {
  ...
  const fetchData = async () => {
    try {
      setRefreshing(true);
      let query = firebase.firestore().collection('lostItems').where('category', '==', 'Wallet').orderBy('date', 'desc');
